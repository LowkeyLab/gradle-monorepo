...
internal class BerUtcTimeBuilder(private val instant: Instant) : BerPrimitiveBuilder(), BerElement {
...
internal class BerGeneralizedTimeBuilder(private val instant: Instant) :
