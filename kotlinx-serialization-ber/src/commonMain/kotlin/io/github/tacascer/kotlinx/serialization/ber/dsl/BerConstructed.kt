...
internal class BerSequenceBuilder : BerConstructedBuilder(), BerSequence {
...
/** SET type builder */
internal class BerSetBuilder : BerConstructedBuilder(), BerSet {
    override fun encode(): ByteArray {
        // First encode children to get their content
        val childrenBytes = children.flatMap { it.encode().toList() }
...
internal class BerSetOfBuilder : BerConstructedBuilder(), BerSetOf {
    override fun encode(): ByteArray {
        // Encode children
